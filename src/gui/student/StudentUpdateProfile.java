...
public class StudentUpdateProfile extends javax.swing.JFrame {
     ...
     */
           ...
           public StudentUpdateProfile() {
            ...
            public StudentUpdateProfile(String username) {
                initComponents();
    ...
    private void initComponents() {
        ...
        tfCurrentUsername.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tfCurrentUsernameActionPerformed(evt);
            }
        });
    ...
    try (
        ...
        while ((line = reader.readLine()) != null) {
            ...
            if (parts.length > 5 && parts[1].trim().equalsIgnoreCase(currentUsername)) {
    ...
    if (updated) {
        if (studentFile.delete()) {
            ...
            JOptionPane.showMessageDialog(null, "Error updating profile file.");
        }
    } else {
    ...
    private void tfCurrentUsernameActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tfCurrentUsernameActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_tfCurrentUsernameActionPerformed
